...
//		 	  }
//	          
//	         if(this.columnFieldNameArray.length > 0 && this.columnFieldNameArray.includes(field)){
...
//			 if(this.columnFieldNameArray.length){
//				 
//				  let index = _.lastIndexOf(this.columnFieldNameArray, fieldVal);
//				  
//						 if (index > -1) {
//							 this.columnFieldNameArray.splice(index, 1);
//						 }
//						 console.log("this.columnFieldNameArray "+this.columnFieldNameArray);
//
//				}
//
//	 }else{
...
//	    	 }
//          this.columnFieldNameArray.push(fieldVal); 
//	 }
//
//	
// 
